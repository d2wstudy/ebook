/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 2f6cae3001a2a4e7d20b5699059332d6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REPO_OWNER" | "REPO_NAME" | "DOCUMENT_PATH_PREFIX" | "DISCUSSION_CATEGORIES" | "ALLOWED_ORIGINS" | "CACHE_FRESH_TTL" | "CACHE_STALE_TTL" | "RATE_LIMIT_RESERVE" | "GRAPHQL_SECONDARY_BUDGET" | "REST_SECONDARY_BUDGET" | "OAUTH_SECONDARY_BUDGET" | "CONTENT_MINUTE_BUDGET" | "CONTENT_HOUR_BUDGET" | "GITHUB_CONCURRENCY_LIMIT" | "MUTATION_MIN_INTERVAL_MS">> {}
}
