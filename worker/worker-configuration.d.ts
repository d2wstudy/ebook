/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 48376880076976a418439dc3e7393fd7)
...
interface __BaseEnv_Env {
	...
	DISCUSSION_CACHE: DurableObjectNamespace<import("./src/index").DiscussionCache>;
	GITHUB_RATE_LIMIT: DurableObjectNamespace<import("./src/index").RateLimitCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DiscussionCache" | "RateLimitCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REPO_OWNER" | "REPO_NAME" | "GITHUB_REPOSITORY_ID" | "DOCUMENT_PATH_PREFIX" | "DISCUSSION_CATEGORIES" | "ALLOWED_ORIGINS" | "CACHE_FRESH_TTL" | "CACHE_STALE_TTL" | "RATE_LIMIT_RESERVE" | "GRAPHQL_SECONDARY_BUDGET" | "REST_SECONDARY_BUDGET" | "OAUTH_SECONDARY_BUDGET" | "CACHE_INVALIDATE_BUDGET" | "CONTENT_MINUTE_BUDGET" | "CONTENT_HOUR_BUDGET" | "GITHUB_CONCURRENCY_LIMIT" | "MUTATION_MIN_INTERVAL_MS">> {}
}
